<div class="flex w-full max-w-4xl gap-10 mx-auto">
    ...
    <div class="flex-1 bg-gray-800 p-8 rounded-lg border border-sky-700">
        ...
        <form action="{{ route('user.login') }}" method="POST" class="flex flex-col gap-4">
            @csrf 
            <input autofocus="true" type="text" name="email" placeholder="Email" class="p-3 rounded bg-gray-900 border border-sky-700 focus:outline-none focus:ring-2 focus:ring-green-500"/>
    ...
    <div class="flex-1 bg-gray-800 p-8 rounded-lg border border-sky-700">
        ...
        <form action="{{ route('user.create') }}" method="POST" class="flex flex-col gap-4">
            ...
            <input type="password" name="password" placeholder="Password" class="p-3 rounded bg-gray-900 border border-sky-700 focus:outline-none focus:ring-2 focus:ring-green-500"/>
            <input type="password" name="password_confirmation" placeholder="Repeat Password" class="p-3 rounded bg-gray-900 border border-sky-700 focus:outline-none focus:ring-2 focus:ring-green-500"/>
